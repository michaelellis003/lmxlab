...
- **20 recipe scripts**: training, fine-tuning, DPO, GRPO, curriculum learning, evaluation, streaming generation, checkpointing, ablation studies, architecture comparison, benchmarking
