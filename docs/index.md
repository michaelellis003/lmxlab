...
- **28 recipe scripts**: training, fine-tuning, ablation studies, architecture comparison, benchmarking
...
- **[Recipes](recipes/index.md)** -- All 28 ready-to-run scripts, categorized.
