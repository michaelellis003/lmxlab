...
- **27 recipe scripts**: training, fine-tuning, ablation studies, architecture comparison, benchmarking
...
- **[Recipes](recipes/index.md)** -- All 27 ready-to-run scripts, categorized.
