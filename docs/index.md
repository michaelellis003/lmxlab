...
- **25 recipe scripts**: training, fine-tuning, ablation studies, architecture comparison, benchmarking
...
- **[Recipes](recipes/index.md)** -- All 25 ready-to-run scripts, categorized.
