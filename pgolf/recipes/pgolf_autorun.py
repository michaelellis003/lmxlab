...
def propose(
    ...
    configs = [
        {
            "env_overrides": {**best_ortho, "WARMDOWN_ITERS": "400"},
            "description": "Warmdown 400 iters (21% of ~1900 steps, vs 63% default)",
            "hypothesis": "HYP-082-wd400",
        },
        {
            "env_overrides": {**best_ortho, "WARMDOWN_ITERS": "200"},
            "description": "Warmdown 200 iters (11% of ~1900 steps, brief cooldown)",
            "hypothesis": "HYP-082-wd200",
        },
    ]
