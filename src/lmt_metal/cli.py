"""Command-line interface for lmt-metal.

Usage:
    lmt-metal info <arch>     Show architecture config details
    lmt-metal list             List available architectures
    lmt-metal count <arch>     Count parameters for an architecture

Examples:
    lmt-metal list
    lmt-metal info gpt
    lmt-metal info llama --tiny
    lmt-metal count deepseek --tiny
"""
